...
// Adjust Page - Compact sliders with GetBuilder
...
class _CompactSliderState extends State<_CompactSlider> {
  ...
  @override
  void didUpdateWidget(_CompactSlider oldWidget) {
  ...
  Widget build(BuildContext context) {
    final isDefault =
        ...
        (_currentValue - widget.defaultValue!).abs() < 0.01;
        ...
        Row(
          children: [
            ...
            SizedBox(
              width: 32,
              child: Text(
                _formatValue(_currentValue, widget.defaultValue),
                style: TextStyle(
                  fontSize: 10,
                  fontWeight: FontWeight.w500,
