...
// // import 'cardmaker/stack_board/src/core/stack_board_item/stack_item_status.dart';
// // import 'cardmaker/stack_board/stack_items.dart';
...
//   /// * Mask
//   Widget _mask() {
//     return Positioned.fill(child: Container(color: Colors.transparent));
//   }
...
//             ),
//             child: Column(
//               children: DrawingBoard.defaultTools(
//                 dc.contentType,
//                 _controller,
//               ).map((DefToolItem item) => _DefToolItem(item: item)).toList(),
//             ),
//           ),
//         );
//       },
...
//   const _DefToolItem({super.key, required this.item});
...
//   const _DefActionItem({super.key, required this.icon, required this.onTap});
...
//     green = (grayColor.green * yRatio + middleColor.green * (1 - yRatio))
//         .toInt();
...
//             onTap: _onTap,
//             child: Container(width: 16, height: 16, color: v.color),
//           ),
//         );
//       },
//     );
...
//                       // 滑动时更新颜色
//                       double hue = (d.localPosition.dx / c.maxWidth) * 360;
...
//                       final Color baseColor = HSVColor.fromAHSV(
//                         1.0,
//                         hue,
//                         1.0,
//                         1.0,
